...
data_all_cleaned <- filter(data1, `Plasma sample_ID` != "#N/A",
													 ...
													 data1$`Plasma sample_ID` !="S100-VD-C-0368", #Hemolyzed
													 data1$`Plasma sample_ID` !="S100-GE-G-0038", #Hemolyzed
													 data1$`Plasma sample_ID` !="S100-GE-G-0059", #Hemolyzed
													 data1$`Plasma sample_ID` !="S100-GE-H-0015", #Hemolyzed
